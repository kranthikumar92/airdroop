...
<ul class="sidebar-panel nav">
  ...
  <li><a href="#"><span class="icon color7"><i class="fa-rocket"></i></span>Airdrop<span class="caret"></span></a>
    <ul>
      <li><a href="airdrops.php">Airdrops List</a></li>
      <li><a href="add-airdrop.php">Add New Airdrop</a></li>
    </ul>
  </li>
  <li><a href="#"><span class="icon color9"><i class="fa-rss-square"></i></span>Blog<span class="caret"></span></a>
    <ul>
      <li><a href="blog-list.php">Posts List</a></li>
      <li><a href="add-blog.php">Add New Post</a></li>
    </ul>
  </li>
  <li><a href="#"><span class="icon color10"><i class="fa-info"></i></span>Information<span class="caret"></span></a>
    <ul>
...
<ul class="sidebar-panel nav">
  ...
  <li><a href="users.php"><span class="icon color15"><i class="fa-users"></i></span>Users</a></li>
  <li><a href="add-user.php"><span class="icon color7"><i class="fa-user"></i></span>Add User</a></li>
</ul>
