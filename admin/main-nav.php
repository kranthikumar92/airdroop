...
<ul class="sidebar-panel nav">
  ...
  <li><a href="contact-messages.php"><span class="icon color6"><i class="fa fa-envelope-o"></i></span>Contact Messages<span class="label label-default">19</span></a></li>
  ...
  <li><a href="#"><span class="icon color8"><i class="fa fa-calendar-o"></i></span>Ads Corner<span class="label label-danger">NEW</span></a></li>
