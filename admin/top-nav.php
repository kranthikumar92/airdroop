...
<!-- Your index.php page HTML code goes here -->
    ...
    <li class="dropdown link">
      <a href="#" data-toggle="dropdown" class="dropdown-toggle profilebox"><img src="img/profileimg.png" alt="img"><b><?php echo "User:" . $_SESSION['username']; ?></b><span class="caret"></span></a>
