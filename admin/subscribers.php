...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Subscribers List</h1>
      <ol class="breadcrumb">
...
if ($result->num_rows > 0) {
    ...
    echo "<thead><tr><th>Sno</th><th>Email Address</th><th>Date Stamp</th><th>Action</th></tr></thead>";
    echo "<tfoot><tr><th>Sno</th><th>Email Address</th><th>Date Stamp</th><th>Action</th></tr></tfoot>";
    echo "<tbody>";
...
// Determine the CSS class for status
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td><a href='delete-subscriber.php?id=" . $row["sno"] . "' class='btn btn-danger'>Delete</a></td>";
        echo "</tr>";
    }

    echo "</tbody></table>";
} else {
    echo "No Subscribers Data Found.";
}
