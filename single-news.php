...
<head>
    ...
    <title>Blog | Airdrop Listo - Crypto Airdrop Listing Template</title>
    ...
    <article class="single-news-content-wrap">
        <header class="article-head">
            <figure class="single-news-thumb">
                <img src="blog_imgs/<?php echo $post['feature_image']; ?>" class="img-fluid" style="min-width: 100%" alt="<?php echo $post['title']; ?>">
            </figure>
